...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BwogComment.article_bwog_id'
        db.alter_column('main_bwogcomment', 'article_bwog_id', self.gf('django.db.models.fields.BigIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'BwogComment.article_bwog_id'
        db.alter_column('main_bwogcomment', 'article_bwog_id', self.gf('django.db.models.fields.BigIntegerField')(default=None))

    models = {
        'main.bwogarticle': {
            'Meta': {'object_name': 'BwogArticle'},
            'body': ('django.db.models.fields.TextField', [], {}),
            'bwog_id': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'main.bwogcomment': {
            ...
            'article_bwog_id': ('django.db.models.fields.BigIntegerField', [], {'null': 'True', 'blank': 'True'}),
