...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BwogComment.parent'
        db.alter_column('main_bwogcomment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['main.BwogComment'], null=True))

    def backwards(self, orm):

        # Changing field 'BwogComment.parent'
        db.alter_column('main_bwogcomment', 'parent_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['main.BwogComment']))
